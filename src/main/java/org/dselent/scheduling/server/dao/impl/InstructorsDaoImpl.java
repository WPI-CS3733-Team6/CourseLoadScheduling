...
public class InstructorsDaoImpl extends BaseDaoImpl<Instructor> implements InstructorsDao
{
	...
	public int updateInstructor(List<String> columnNameList, List<Object> newValueList, List<QueryTerm> queryTermList) {
		...
		String queryTemplate = QueryStringBuilder.generateUpdateString(Instructor.TABLE_NAME, columnNameList, queryTermList);	//Here's where the column names are fille din
