...
public class CourseInformationDaoImpl extends BaseDaoImpl<CourseInformation> implements CourseInformationDao
{
	...
	public int updateCourse(List<String> columnNameList, List<Object> newValueList, List<QueryTerm> queryTermList) {
		String queryTemplate = QueryStringBuilder.generateUpdateString(CourseInformation.TABLE_NAME, columnNameList, queryTermList);	//Here's where the column names are fille din
	...
	private void addParameterMapValue(MapSqlParameterSource parameters, String insertColumnName, CourseInformation courseInformationModel)
	{
    	...
    	else if(insertColumnName.equals(CourseInformation.getColumnName(CourseInformation.Columns.COURSE_DESCRIPTION)))
    	{
    		parameters.addValue(parameterName, courseInformationModel.getCourseDescription());
    	}
	...
	private void addObjectValue(Map<String, Object> keyMap, String keyHolderColumnName, CourseInformation courseInformationModel)
	{
    	...
    	else if(keyHolderColumnName.equals(CourseInformation.getColumnName(CourseInformation.Columns.COURSE_DESCRIPTION)))
    	{
    		courseInformationModel.setCourseDescription((String) keyMap.get(keyHolderColumnName));
    	}
