...
public class InstructorCourseLinkRegisteredDaoImpl extends BaseDaoImpl<InstructorCourseLinkRegistered> implements InstructorCourseLinkRegisteredDao
{
	...
	public int updateInstructorCourseLinkRegistered(List<String> columnNameList, List<Object> newValueList, List<QueryTerm> queryTermList) {
		...
		String queryTemplate = QueryStringBuilder.generateUpdateString(InstructorCourseLinkRegistered.TABLE_NAME, columnNameList, queryTermList);	//Here's where the column names are fille din
	...
	private void addParameterMapValue(MapSqlParameterSource parameters, String insertColumnName, InstructorCourseLinkRegistered instructorCourseLinkRegisteredModel)
	{
    	...
    	else if(insertColumnName.equals(InstructorCourseLinkRegistered.getColumnName(InstructorCourseLinkRegistered.Columns.INSTANCE_ID)))
    	{
    		parameters.addValue(parameterName, instructorCourseLinkRegisteredModel.getInstanceId());
    	}
	...
	private void addObjectValue(Map<String, Object> keyMap, String keyHolderColumnName, InstructorCourseLinkRegistered instructorCourseLinkRegisteredModel)
	{
    	...
    	else if(keyHolderColumnName.equals(InstructorCourseLinkRegistered.getColumnName(InstructorCourseLinkRegistered.Columns.INSTANCE_ID)))
    	{
    		instructorCourseLinkRegisteredModel.setInstanceId((Integer) keyMap.get(keyHolderColumnName));
    	}
