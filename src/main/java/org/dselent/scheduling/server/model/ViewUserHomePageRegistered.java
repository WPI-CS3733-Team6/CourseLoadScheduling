...
public class ViewUserHomePageRegistered extends Model{
	
	//table name
	public static final String TABLE_NAME = "view_user_homepage_registered";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ViewUserHomePageRegistered other = (ViewUserHomePageRegistered) obj;
		if (courseNum == null) {
