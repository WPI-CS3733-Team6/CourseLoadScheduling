...
import javax.annotation.Generated;
	...
	public class UserAllUsersDto
	{
		...
		/**
		 * Creates builder to build {@link UserAllUsersDto}.
		...
		/**
		 * Builder to build {@link UserAllUsersDto}.
		 */
		@Generated("SparkTools")
		...
		public String toString() {
			return "UserAllUsersDto [userId=" + userId + ", currentPassword=" + currentPassword + ", newPassword="
